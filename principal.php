...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-navy">
    ...
    <a href="#" class="brand-link">
      ...
      <img src="dist/img/logo-icon.jpg" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">ALQUILER DE MOTOS</span>
    </a>
